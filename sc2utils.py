...
#
def GetApplicationWindow(windowName, filename):
    hwnd = win32gui.FindWindow(None, windowName)
    if hwnd==False:
        print("Cannot find window: " + str(windowName))
        return False
...
#####################################################
#
# Author: https://gist.github.com/chriskiehl/2906125
#
#####################################################
